-- 에브리슬립 정규화된 데이터 시딩
-- Generated from Excel files with normalized schema
...
VALUES ('S001', '가장 행복한 꿈', '에브리슬립', 'https://jxfeszksnsyelaqcfapv.supabase.co/storage/v1/object/public/audio-tracks/happiest_dream.mp3', NULL, '자연음', 260, 70, 'happiest_dream.mp3', '포근한 이불 속에서, 편안한 피아노 선율이 가장 행복했던 순간을 떠올리게 합니다. ', false, 1);
INSERT INTO tracks (code, title, artist, url, thumbnail, category, duration_seconds, bpm, file_name, description, is_asmr, display_order) 
...
INSERT INTO tracks (code, title, artist, url, thumbnail, category, duration_seconds, bpm, file_name, description, is_asmr, display_order) 
VALUES ('S003', '다정한 휴식', '에브리슬립', 'https://jxfeszksnsyelaqcfapv.supabase.co/storage/v1/object/public/audio-tracks/gentle_jazz.mp3', NULL, '자연음', 183, 80, 'gentle_jazz.mp3', '음악은 말없이 곁을 지켜주는 친구, 경쾌한 재즈 어떠세요?', false, 3);
INSERT INTO tracks (code, title, artist, url, thumbnail, category, duration_seconds, bpm, file_name, description, is_asmr, display_order) 
...
INSERT INTO tracks (code, title, artist, url, thumbnail, category, duration_seconds, bpm, file_name, description, is_asmr, display_order) 
VALUES ('S016', '어른들의 자장가', '에브리슬립', 'https://jxfeszksnsyelaqcfapv.supabase.co/storage/v1/object/public/audio-tracks/adults_lullaby.mp3', NULL, '자연음', 300, 65, 'adults_lullaby.mp3', '따뜻한 피아노 멜로디가 어릴 적 듣던 자장가처럼 마음을 위로해줍니다.', false, 16);
INSERT INTO tracks (code, title, artist, url, thumbnail, category, duration_seconds, bpm, file_name, description, is_asmr, display_order) 
...
INSERT INTO tracks (code, title, artist, url, thumbnail, category, duration_seconds, bpm, file_name, description, is_asmr, display_order) 
VALUES ('S018', '좋은 꿈을 꿀거예요', '에브리슬립', 'https://jxfeszksnsyelaqcfapv.supabase.co/storage/v1/object/public/audio-tracks/have_good_dream.mp3', NULL, '자연음', 256, 73, 'have_good_dream.mp3', '불 끄고 누워 조용히 눈을 감고 함께하는 연주, 포근한 멜로디가 당신을 좋은 꿈으로 이끌어줍니다.', false, 18);
INSERT INTO tracks (code, title, artist, url, thumbnail, category, duration_seconds, bpm, file_name, description, is_asmr, display_order) 
VALUES ('S019', '평화로운 나의 아침', '에브리슬립', 'https://jxfeszksnsyelaqcfapv.supabase.co/storage/v1/object/public/audio-tracks/peaceful_morning.mp3', NULL, '자연음', 193, 60, 'peaceful_morning.mp3', '햇살이 커튼 사이로 스며드는 지금, 평화로운 아침의 공기를 닮은 곡이 하루를 부드럽게 열어줍니다.', false, 19);
INSERT INTO tracks (code, title, artist, url, thumbnail, category, duration_seconds, bpm, file_name, description, is_asmr, display_order) 
...
INSERT INTO tracks (code, title, artist, url, thumbnail, category, duration_seconds, bpm, file_name, description, is_asmr, display_order) 
VALUES ('S022', '햇살 가득한 하루', '에브리슬립', 'https://jxfeszksnsyelaqcfapv.supabase.co/storage/v1/object/public/audio-tracks/sunshine_day.mp3', NULL, '자연음', 587, 62, 'sunshine_day.mp3', '창문을 열고 햇살이 방 안을 환하게 채우고 뒤이어 들리는 피아노가 하루의 시작을 다독여줍니다.', false, 22);
INSERT INTO tracks (code, title, artist, url, thumbnail, category, duration_seconds, bpm, file_name, description, is_asmr, display_order) 
VALUES ('S023', '햇살 가득한 하루', '에브리슬립', 'https://jxfeszksnsyelaqcfapv.supabase.co/storage/v1/object/public/audio-tracks/sunshine_day_asmr.mp3', NULL, '자연음', 589, 62, 'sunshine_day_asmr.mp3', '햇살 속을 걷는 듯한 연주와 어우러지는 새소리가 여유로운 하루를 만들어줍니다.', false, 23);
INSERT INTO tracks (code, title, artist, url, thumbnail, category, duration_seconds, bpm, file_name, description, is_asmr, display_order) 
...
-- THEMES 테이블 데이터
INSERT INTO themes (code, title, subtitle, description, display_order) 
VALUES ('theme_1', '숙면 테라피', '매일 편안한 밤을 위한 맞춤형 음원을 만나보세요.', '안정적인 심박수에 최적화된 BPM과 규칙적인 리듬으로 설계하여 뇌파를 안정시키고, 깊은 이완을 유도하여 수면에 도움을 줍니다.', 1);
INSERT INTO themes (code, title, subtitle, description, display_order) 
VALUES ('theme_2', '마음 테라피', '편안한 심신과 평온을 되찾아 드립니다.', '불안하고 긴장된 마음을 위한 맞춤형 사운드입니다. 고요하고 조화로운 소리가 심리적 안정감을 경험하도록 돕습니다.', 2);
INSERT INTO themes (code, title, subtitle, description, display_order) 
VALUES ('theme_3', '이명 케어(자연소리)', '이명 소리를 케어해주는 편안한 자연의 소리를 만나보세요.', '이명을 효과적으로 마스킹할 수 있도록 설계한 백색소음 입니다. 평온하고 안정적인 상태를 돕습니다.', 3);
INSERT INTO themes (code, title, subtitle, description, display_order) 
VALUES ('theme_4', '활력 부스터', '지친 하루에 새로운 활력을 채워보세요.', '활기찬 에너지를 채우는 100BPM이상의 리듬을 고려하여 더욱 경쾌하고 긍정적인 분위기를 만들어줍니다. ', 4);
INSERT INTO themes (code, title, subtitle, description, display_order) 
VALUES ('theme_5', '자연의 음악', '아름다운 음악에 자연의 소리를 더해 풍요로운 일상을 선사합니다.', '시원한 파도, 편안한 빗소리, 자연의 소리와 음악을 함께 설계하였습니다. 즉각적인 안정 효과를 느껴보세요.', 5);
INSERT INTO themes (code, title, subtitle, description, display_order) 
VALUES ('theme_6', '일상의 낭만', '커피 한 잔, 즐거운 식사, 산책 등 특별한 감성을 더해드립니다.', '감각적인 재즈, 낭만적인 클래식을 더하여 공간에 맞는 음악을 더해보세요.', 6);

-- 키워드 데이터 추출 및 삽입
INSERT INTO keywords (name, category) VALUES ('긍정', '기타') ON CONFLICT (name) DO NOTHING;
INSERT INTO keywords (name, category) VALUES ('기분전환', '기타') ON CONFLICT (name) DO NOTHING;
INSERT INTO keywords (name, category) VALUES ('수면', '효과') ON CONFLICT (name) DO NOTHING;
INSERT INTO keywords (name, category) VALUES ('안정', '효과') ON CONFLICT (name) DO NOTHING;
INSERT INTO keywords (name, category) VALUES ('이명완화', '기타') ON CONFLICT (name) DO NOTHING;
INSERT INTO keywords (name, category) VALUES ('이명케어', '기타') ON CONFLICT (name) DO NOTHING;
INSERT INTO keywords (name, category) VALUES ('이완', '효과') ON CONFLICT (name) DO NOTHING;
INSERT INTO keywords (name, category) VALUES ('집중', '효과') ON CONFLICT (name) DO NOTHING;
INSERT INTO keywords (name, category) VALUES ('활력', '효과') ON CONFLICT (name) DO NOTHING;

-- 테마-기분 관계 데이터
INSERT INTO theme_moods (theme_id, mood_id)
SELECT t.id, m.id FROM themes t, moods m 
WHERE t.code = 'theme_1' AND m.name = '푹 자고 싶어요';
INSERT INTO theme_moods (theme_id, mood_id)
SELECT t.id, m.id FROM themes t, moods m 
WHERE t.code = 'theme_1' AND m.name = '낮잠이 필요해요';
INSERT INTO theme_moods (theme_id, mood_id)
SELECT t.id, m.id FROM themes t, moods m 
WHERE t.code = 'theme_2' AND m.name = '지쳤어요';
INSERT INTO theme_moods (theme_id, mood_id)
SELECT t.id, m.id FROM themes t, moods m 
WHERE t.code = 'theme_3' AND m.name = '귀에서 소리가 나요';
INSERT INTO theme_moods (theme_id, mood_id)
SELECT t.id, m.id FROM themes t, moods m 
WHERE t.code = 'theme_4' AND m.name = '기운이 없어요';
INSERT INTO theme_moods (theme_id, mood_id)
SELECT t.id, m.id FROM themes t, moods m 
WHERE t.code = 'theme_5' AND m.name = '조용히 쉬고싶어요';
INSERT INTO theme_moods (theme_id, mood_id)
SELECT t.id, m.id FROM themes t, moods m 
WHERE t.code = 'theme_6' AND m.name = '기분 전환하고 싶어요';

-- 테마-트랙 관계 데이터
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 1 FROM themes t, tracks tr 
WHERE t.code = 'theme_1' AND tr.code = 'S001';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 2 FROM themes t, tracks tr 
WHERE t.code = 'theme_1' AND tr.code = 'S007';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 3 FROM themes t, tracks tr 
WHERE t.code = 'theme_1' AND tr.code = 'S008';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 4 FROM themes t, tracks tr 
WHERE t.code = 'theme_1' AND tr.code = 'S010';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 5 FROM themes t, tracks tr 
WHERE t.code = 'theme_1' AND tr.code = 'S013';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 6 FROM themes t, tracks tr 
WHERE t.code = 'theme_1' AND tr.code = 'S014';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 7 FROM themes t, tracks tr 
WHERE t.code = 'theme_1' AND tr.code = 'S016';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 8 FROM themes t, tracks tr 
WHERE t.code = 'theme_1' AND tr.code = 'S030';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 1 FROM themes t, tracks tr 
WHERE t.code = 'theme_2' AND tr.code = 'S002';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 2 FROM themes t, tracks tr 
WHERE t.code = 'theme_2' AND tr.code = 'S004';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 3 FROM themes t, tracks tr 
WHERE t.code = 'theme_2' AND tr.code = 'S005';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 4 FROM themes t, tracks tr 
WHERE t.code = 'theme_2' AND tr.code = 'S006';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 5 FROM themes t, tracks tr 
WHERE t.code = 'theme_2' AND tr.code = 'S008';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 6 FROM themes t, tracks tr 
WHERE t.code = 'theme_2' AND tr.code = 'S013';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 7 FROM themes t, tracks tr 
WHERE t.code = 'theme_2' AND tr.code = 'S015';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 8 FROM themes t, tracks tr 
WHERE t.code = 'theme_2' AND tr.code = 'S017';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 9 FROM themes t, tracks tr 
WHERE t.code = 'theme_2' AND tr.code = 'S018';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 10 FROM themes t, tracks tr 
WHERE t.code = 'theme_2' AND tr.code = 'S019';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 11 FROM themes t, tracks tr 
WHERE t.code = 'theme_2' AND tr.code = 'S022';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 1 FROM themes t, tracks tr 
WHERE t.code = 'theme_3' AND tr.code = 'S031';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 2 FROM themes t, tracks tr 
WHERE t.code = 'theme_3' AND tr.code = 'S032';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 3 FROM themes t, tracks tr 
WHERE t.code = 'theme_3' AND tr.code = 'S033';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 4 FROM themes t, tracks tr 
WHERE t.code = 'theme_3' AND tr.code = 'S034';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 5 FROM themes t, tracks tr 
WHERE t.code = 'theme_3' AND tr.code = 'S035';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 6 FROM themes t, tracks tr 
WHERE t.code = 'theme_3' AND tr.code = 'S036';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 1 FROM themes t, tracks tr 
WHERE t.code = 'theme_4' AND tr.code = 'S003';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 2 FROM themes t, tracks tr 
WHERE t.code = 'theme_4' AND tr.code = 'S004';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 3 FROM themes t, tracks tr 
WHERE t.code = 'theme_4' AND tr.code = 'S020';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 4 FROM themes t, tracks tr 
WHERE t.code = 'theme_4' AND tr.code = 'S024';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 5 FROM themes t, tracks tr 
WHERE t.code = 'theme_4' AND tr.code = 'S025';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 6 FROM themes t, tracks tr 
WHERE t.code = 'theme_4' AND tr.code = 'S028';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 1 FROM themes t, tracks tr 
WHERE t.code = 'theme_5' AND tr.code = 'S008';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 2 FROM themes t, tracks tr 
WHERE t.code = 'theme_5' AND tr.code = 'S009';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 3 FROM themes t, tracks tr 
WHERE t.code = 'theme_5' AND tr.code = 'S011';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 4 FROM themes t, tracks tr 
WHERE t.code = 'theme_5' AND tr.code = 'S012';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 5 FROM themes t, tracks tr 
WHERE t.code = 'theme_5' AND tr.code = 'S021';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 6 FROM themes t, tracks tr 
WHERE t.code = 'theme_5' AND tr.code = 'S023';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 1 FROM themes t, tracks tr 
WHERE t.code = 'theme_6' AND tr.code = 'S003';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 2 FROM themes t, tracks tr 
WHERE t.code = 'theme_6' AND tr.code = 'S026';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 3 FROM themes t, tracks tr 
WHERE t.code = 'theme_6' AND tr.code = 'S027';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 4 FROM themes t, tracks tr 
WHERE t.code = 'theme_6' AND tr.code = 'S028';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 5 FROM themes t, tracks tr 
WHERE t.code = 'theme_6' AND tr.code = 'S029';
INSERT INTO theme_tracks (theme_id, track_id, display_order)
SELECT t.id, tr.id, 6 FROM themes t, tracks tr 
WHERE t.code = 'theme_6' AND tr.code = 'S031';
