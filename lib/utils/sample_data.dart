  ...
  static List<Track> getNatureSoundEffects() {
    return [
      Track(
        ...
        thumbnail: 'assets/images/bird.jpg', // 새소리(ASMR)
        category: '자연음',
      ...
      Track(
        ...
        thumbnail: 'assets/images/fire.jpg', // 장작불소리(ASMR)
        category: '자연음',
        durationSeconds: null, // 반복 재생
        bpm: null,
        displayOrder: 1002,
      ...
      Track(
        ...
        thumbnail: 'https://images.unsplash.com/photo-1428592953211-077101b2021b?w=300&h=300&fit=crop', // 빗소리 - 창문에 떨어지는 빗방울
        category: '자연음',
        durationSeconds: null, // 반복 재생
        bpm: null,
        displayOrder: 1003,
      ...
      Track(
        ...
        thumbnail: 'assets/images/water.jpg', // 물소리(ASMR)
        category: '자연음',
        durationSeconds: null, // 반복 재생
        bpm: null,
        displayOrder: 1004,
      ...
      Track(
        ...
        thumbnail: 'assets/images/wave.jpg', // 파도소리(ASMR)
        category: '자연음',
        durationSeconds: null, // 반복 재생
        bpm: null,
        displayOrder: 1005,
      ...
      Track(
        ...
        thumbnail: 'assets/images/wind.jpg', // 바람소리(ASMR)
        category: '자연음',
        durationSeconds: null, // 반복 재생
        bpm: null,
        displayOrder: 1006,
  ...
  static List<Track> getAllTracks() {
    ...
    final musicTracks = [
      ...
      Track(
        ...
        thumbnail: 'assets/images/wolf-zimmermann-6sf5rf8QYFE-unsplash.jpg',
        category: '수면음악',
      ...
      Track(
        ...
        thumbnail: 'assets/images/c2.jpg', // 좋은 꿈을 꿀거예요 커스텀 이미지
        category: '수면음악',
      ...
      Track(
        ...
        thumbnail: 'assets/images/re2.jpg', // 다정한 휴식 커스텀 이미지
        category: '명상음악',
      ...
      Track(
        ...
        thumbnail: 'assets/images/f3.jpg', // 평화로운 나의 아침 커스텀 이미지
        category: '명상음악',
      ...
      Track(
        ...
        thumbnail: 'assets/images/f4.jpg', // 햇살 가득한 하루 커스텀 이미지
        category: '활력음악',
      ...
      Track(
        ...
        thumbnail: 'assets/images/f4.jpg', // 햇살 가득한 하루 (ASMR) 커스텀 이미지
        category: '활력음악',
      ...
      Track(
        ...
        thumbnail: 'assets/images/f1.jpg', // 들꽃처럼 피어나는 희망 커스텀 이미지
        category: '수면음악',
      ...
      Track(
        ...
        thumbnail: 'assets/images/shche_-team-0dszrg9-V1o-unsplash.jpg', // 행복이 있는 식탁 커스텀 이미지
        category: '활력음악',
      ...
      Track(
        ...
        thumbnail: 'assets/images/thankyou.jpg', // 감사의 일기
        category: '수면음악',
      ...
      Track(
        ...
        thumbnail: 'assets/images/giulia-bertelli-dvXGnwnYweM-unsplash.jpg', // 마음을 다독이며 - 가슴에 손을 올린 따뜻한 이미지
        category: '수면음악',
      ...
      Track(
        ...
        thumbnail: 'assets/images/marek-piwnicki-iwabZE-qN_U-unsplash.jpg', // 별빛이 남긴 추억 커스텀 이미지
        category: '수면음악',
      ...
      // tracks 폴더의 자연음 트랙들 (플레이리스트용)
      Track(
        id: 2001,
        code: 'T001',
        title: '새소리 자연음',
        artist: 'everysleep',
        url: 'https://jxfeszksnsyelaqcfapv.supabase.co/storage/v1/object/public/everysleeptrack/tracks/E001_BIRD ASMR1.mp3',
        thumbnail: 'assets/images/bird.jpg',
        category: '자연음',
        durationSeconds: null, // 반복 재생
        bpm: null,
        displayOrder: 2001,
        fileName: 'E001_BIRD ASMR1.mp3',
        description: '이른 아침 새들의 인사소리로 하루를 시작해보세요.',
        effectKeywords: ['이명케어', '자연음'],
        isAsmr: true,
        createdAt: DateTime.now(),
      ),
      Track(
        ...
        title: '장작불소리 자연음',
        artist: 'everysleep',
        url: 'https://jxfeszksnsyelaqcfapv.supabase.co/storage/v1/object/public/everysleeptrack/tracks/E002_FIRE ASMR.mp3',
        thumbnail: 'assets/images/fire.jpg',
        category: '자연음',
        durationSeconds: null, // 반복 재생
        bpm: null,
        displayOrder: 2002,
        fileName: 'E002_FIRE ASMR.mp3',
        description: '따뜻한 장작불 소리로 마음의 평온을 찾아보세요.',
        effectKeywords: ['이명케어', '자연음'],
        isAsmr: true,
        createdAt: DateTime.now(),
      ),
      Track(
        ...
        title: '빗소리 자연음',
        artist: 'everysleep',
        url: 'https://jxfeszksnsyelaqcfapv.supabase.co/storage/v1/object/public/everysleeptrack/tracks/E003_RAIN ASMR2.mp3',
        thumbnail: 'assets/images/rain.jpg',
        category: '자연음',
        durationSeconds: null, // 반복 재생
        bpm: null,
        displayOrder: 2003,
        fileName: 'E003_RAIN ASMR2.mp3',
        description: '부드러운 빗소리가 주는 자연의 위로를 느껴보세요.',
        effectKeywords: ['이명케어', '자연음'],
        isAsmr: true,
        createdAt: DateTime.now(),
      ),
      Track(
        ...
        title: '물소리 자연음',
        artist: 'everysleep',
        url: 'https://jxfeszksnsyelaqcfapv.supabase.co/storage/v1/object/public/everysleeptrack/tracks/E005_WATER ASMR.mp3',
        thumbnail: 'assets/images/water.jpg',
        category: '자연음',
        durationSeconds: null, // 반복 재생
        bpm: null,
        displayOrder: 2004,
        fileName: 'E005_WATER ASMR.mp3',
        description: '맑고 시원한 물소리로 마음을 정화해보세요.',
        effectKeywords: ['이명케어', '자연음'],
        isAsmr: true,
        createdAt: DateTime.now(),
      ),
      Track(
        ...
        title: '파도소리 자연음',
        artist: 'everysleep',
        url: 'https://jxfeszksnsyelaqcfapv.supabase.co/storage/v1/object/public/everysleeptrack/tracks/E004_WAVE ASMR.mp3',
        thumbnail: 'assets/images/wave.jpg',
        category: '자연음',
        durationSeconds: null, // 반복 재생
        bpm: null,
        displayOrder: 2005,
        fileName: 'E004_WAVE ASMR.mp3',
        description: '시원한 바닷바람과 파도소리로 휴식을 취하세요.',
        effectKeywords: ['이명케어', '자연음'],
        isAsmr: true,
        createdAt: DateTime.now(),
      ...
      Track(
        ...
        title: '바람소리 자연음',
        artist: 'everysleep',
        url: 'https://jxfeszksnsyelaqcfapv.supabase.co/storage/v1/object/public/everysleeptrack/tracks/E006_WIND ASMR.mp3',
        thumbnail: 'assets/images/wind.jpg',
        category: '자연음',
        durationSeconds: null, // 반복 재생
        bpm: null,
        displayOrder: 2006,
        fileName: 'E006_WIND ASMR.mp3',
        description: '시원해지는 숲 속의 바람소리로 마음을 이완시켜보세요.',
        effectKeywords: ['이명케어', '자연음'],
        isAsmr: true,
        createdAt: DateTime.now(),
